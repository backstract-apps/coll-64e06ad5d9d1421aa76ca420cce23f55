...
class Appointments(Base):
    ...
    appointment_date = Column(Date, primary_key=False)
    appointment_time = Column(String, primary_key=False)
    purpose = Column(String, primary_key=False)
...
class CalendarIntegration(Base):
    ...
    calendar_details = Column(String, primary_key=False)
