...
app = FastAPI(title='Backstract Generated APIs - coll-64e06ad5d9d1421aa76ca420cce23f55', debug=False,
              docs_url='/gracious-yash-aa8b55ea3afd11f09697a2b4aab8ab5535/docs',
              openapi_url='/gracious-yash-aa8b55ea3afd11f09697a2b4aab8ab5535/openapi.json')
...
app.include_router(
    router,
    prefix='/gracious-yash-aa8b55ea3afd11f09697a2b4aab8ab5535/api',
    tags=['APIs v1']
)
